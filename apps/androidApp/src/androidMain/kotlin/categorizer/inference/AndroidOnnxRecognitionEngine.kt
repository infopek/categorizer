...
class AndroidOnnxRecognitionEngine(
    ...
    private data class LoadedBundle(val environment:OrtEnvironment,val session:OrtSession,val manifest:Manifest,val classes:List<CategoryIdentity>)
