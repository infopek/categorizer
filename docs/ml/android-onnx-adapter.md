...
No candidate binary is committed by ML-006. Until an approved bundle is placed in `apps/androidApp/src/androidMain/assets/recognition/`, the application honestly returns `MODEL_UNAVAILABLE`.
